<div class="modal fade" id="detailTransaction{{ $transaction['id'] }}" tabindex="-1" aria-labelledby="detailTransactionLabel{{ $transaction['id'] }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content rounded-4 shadow-lg">
            <div class="modal-header bg-gradient text-white">
                <h5 class="modal-title" id="detailTransactionLabel{{ $transaction['id'] }}">
                    <i class="fas fa-file-invoice-dollar"></i> <strong>Detail Transaksi</strong> - {{ $transaction['transaction_code'] }}
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-8">
                        <span class="text-dark">{{ \Carbon\Carbon::parse($transaction['transaction_date'])->format('d-m-Y') }}</span>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-md-4">
