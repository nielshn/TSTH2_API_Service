                ...
                <div class="d-flex align-items-start mb-3">
                    ...
                    <div class="flex-fill">
                        ...
                        <div class="d-flex my-2">
                            ...
                            <a href="#" class="status-indicator-container me-1">
                                <img src="{{ asset('template/assets/images/demo/users/face12.jpg') }}"
                                    class="w-32px h-32px rounded-pill" alt="">
                                <span class="status-indicator bg-success"></span>
                            </a>
                            <a href="#" class="status-indicator-container me-1">
                                <img src="{{ asset('template/assets/images/demo/users/face13.jpg') }}"
                                    class="w-32px h-32px rounded-pill" alt="">
                                <span class="status-indicator bg-success"></span>
                            </a>
                            <button type="button"
                    ...
                    <div class="flex-fill">
                        ...
                        <div class="bg-light rounded p-2 my-2">
                            <div class="d-flex align-items-center">
                                <div class="me-2">
                                    <img src="{{ asset('template/assets/images/icons/pdf.svg') }}" width="34"
                                        height="34" alt="">
                                </div>
                                <div class="flex-fill">
                                    new_contract.pdf
